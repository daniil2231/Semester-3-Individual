package fontys.pls.work.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(fontys.pls.work.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(fontys.pls.work.configuration.security.isauthenticated.IsAuthenticated)")

...
@SpringBootTest
public class ChangeTraderFundsUseCaseImplTest {
    ...
    @InjectMocks
    private ChangeTraderFundsUseCaseImpl changeTraderFundsUseCase;

    @Test
    void shouldChangeTraderFunds() {
        ...
        Trader updated = changeTraderFundsUseCase.changeTraderFunds(1000.0, 1L);

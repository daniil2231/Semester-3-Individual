...
@SpringBootTest
public class ChangeTraderTradedVolumeUseCaseImplTest {
    ...
    @InjectMocks
    private ChangeTraderTradedVolumeUseCaseImpl changeTraderVolumeUseCase;

    @Test
    void shouldChangeTraderVolume() {
        ...
        Trader updated = changeTraderVolumeUseCase.changeTraderTradedVolume(1000.0, 1L);

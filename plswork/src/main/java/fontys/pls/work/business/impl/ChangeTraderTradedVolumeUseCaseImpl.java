...
@Service
@AllArgsConstructor
public class ChangeTraderTradedVolumeUseCaseImpl implements ChangeTraderTradedVolumeUseCase {
    ...
    @Override
    public Trader changeTraderTradedVolume(Double amount, Long id) {
        ...
        Double newAmountOfVolume = trader.getTradedVolume() + amount;

        trader.setTradedVolume(newAmountOfVolume);
